...
/**
 * Trieda definujuca metametakonfiguraciu (metakonfiguraciu nastroja),
 * poskytuje informacie potrebne pre spracovanie metakonfiguracie (konfiguracie
 * nastroja).
 * @author Milan
 */
public class BTEMetaConfigurationLoader implements MetaConfigurationLoader {
    ...
    /**
     * Vypis varovani je predvolene nastaveny, aby pouzivatela varoval
     * pri chybach konfigurovania nastroja.
     */
